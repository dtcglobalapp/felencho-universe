...
try {
const response = await fetch("/api/lumina_producer/session", {
method: "PATCH",
headers: {
...
return ( <section className="mt-10 rounded-2xl border border-cyan-400/30 bg-white/5 p-6 shadow-lg shadow-cyan-500/10"> <h2 className="text-2xl font-bold text-cyan-300">
Lumina Producer </h2>
...
```
  ...
  <div className="mt-6 flex flex-wrap gap-3">
    ...
    <button
      ...
      className="rounded-xl bg-yellow-600 px-4 py-2 font-semibold"
    >
      PAUSE
    </button>
